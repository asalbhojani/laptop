...
class AlienWare extends StatefulWidget {
  const AlienWare({super.key});

  @override
  State<AlienWare> createState() => _AlienWareState();
}

class _AlienWareState extends State<AlienWare> {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder(
                              stream: FirebaseFirestore.instance.collection("Product-Data").where('Product-Brand',isEqualTo: "ALIEN WARE")
                                  .snapshots(),
