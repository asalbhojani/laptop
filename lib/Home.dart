                    ...
                    Container(
                      ...
                      child: ElevatedButton(onPressed: (){
                        setState(() {
                          ...
                          if(selectedIndex==1){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=> AlienWare(),));
                          }
                          if(selectedIndex==2){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=> Asus(),));
                          }
                          if(selectedIndex==3){
